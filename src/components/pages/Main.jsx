    ...
    return (
        <React.Fragment>
            <FormContainer style={{alignItems: "flex-start"}}>
                <InputComponent inputValue={value} action={handleChangeValue} placeholder={"Transaction sum"} maxLength={"100"}/>
                ...
                {type === "profit" && <InputComponent inputValue={comment} action={handleChangeComment} placeholder={"Enter comment"} maxLength={"100"}/>}
                <Button 
                    backgroundColor={
